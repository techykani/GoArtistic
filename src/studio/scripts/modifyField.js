...
const MODIFIED_FIELD_NAME = `language`
...
const fetchDocuments = () =>
  client.fetch(
    ...
    // `*[_type != "translation.metadata" && _type != "system.group" && _type != "system.retention" && !defined(language) && !defined(assetId)][0...5] {
    `*[_type == "" && !defined(language)][0...100] {
      _id, 
      _rev, 
    }`,
    // { type: SCHEMA_TYPE },
