...
const Title = ({ tagline, headingType, theme, className }: TitleProps) => {
  return (
    <>
      {headingType == 'h1' && (
        <h1
          className={` text-[#FEFEFE] text-[32px] md:text-[40px] font-bold leading-[38px] md:leading-[48px] tracking-[0.32px] md:tracking-[0.8px] whitespace-pre-line ${style.montserrat} ${className}`}
        >
          {tagline}
        </h1>
      )}
