...
const InformativeCard: React.FC<any> = ({
  ...
  return (
    <>
      <div
        className="w-full h-full flex flex-col md:flex-row gap-4 py-12 px-6 md:px-[71px] md:py-20 bg-[#F1F6FF]"
        key={_id}
      >
        <div className="flex flex-col md:flex-row gap-6 px-6 container">
          ...
          <div className="w-full flex flex-col justify-center lg:gap-6 gap-4 md:pl-8">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <p className="text-[#AAA] text-[12px] font-medium my-auto leading-[20px] tracking-[0.36px] uppercase pt-[6px]">IS NOW</p>
              {teritaryImg && (
            ...
            {title && (
              <h3
                className={`text-primary-blue-new text-[26px] md:text-[32px] font-montserrat font-bold leading-[32px] tracking-[0.32px] ${windowWidth >= 768 && windowWidth <= 1014 && 'h-[72px]'
                  }`}
              >
                {title}
              </h3>
