...
export const Locations: React.FC<any> = ({ title, clinicLocations, link }) => {
              ...
              <div className="" key={index}>
                <div className="max-w-[392px]  bg-off-white rounded-xl overflow-hidden shadow-megaMenu">
                  ...
                  <div className="p-6 flex flex-col h-[252px] lg2:h-[230px]">
                    ...
                    <span className="flex gap-1 text-sm font-normal leading-5 text-grey-9 pt-2">
            ...
            {clinicLocations?.map((location: any, index: any) => (
              <SwiperSlide className="!w-[288px] !ml-[24px] !mr-0" key={index}>
                <div className="flex justify-center">
                  <div className="max-w-[392px] w-[288px] h-[250px] my-6 bg-off-white rounded-xl shadow-megaMenu">
                    {/* <div className="">
                      <SanityImg
