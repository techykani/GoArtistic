    ...
    <section
      ...
      className={`flex md:justify-center bg-surface-light-neutral-2  ${
        isSticky && isAnnouncementBarAvailable === 'true'
          ? 'sticky h-[70px] lg:h-[70px] top-0 md:top-[172px] z-[999] pt-3 lg:pt-[18px]'
          : 'sticky h-[70px] lg:h-[70px] top-0 z-[999] pt-3 lg:pt-[18px] md:top-[135px]'
      }`}
    >
