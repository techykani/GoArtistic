      ...
      <div>
        ...
        {tabParameters.indexOf(selectedTab) === 2 && (
          <Fragment>
            ...
            {/* {filterByDoc(allData, 'package').length !== 0 && (
              <AllResult
                allData={filterByDoc(allData, 'package')}
                seeMoreButtonText={seeMoreButtonText[2]}
                seeLessButtonText={seeLessButtonText[2]}
              />
            )} */}
          </Fragment>
        )}
        ...
        {tabParameters.indexOf(selectedTab) === 3 && (
          <Fragment>
            ...
            {/* {filterByDoc(allData, 'media').length !== 0 && (
              <AllResult
                allData={filterByDoc(allData, 'media')}
                seeMoreButtonText={seeMoreButtonText[3]}
                seeLessButtonText={seeLessButtonText[3]}
              />
            )} */}
